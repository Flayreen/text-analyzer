...
import getMetricDescription from "@/services/get-metric-description";
                    ...
                    scores: [
                        {
                            ...
                            description: getMetricDescription("fleschReadingEase", metrics.fleschReadingEase),
                        },
                        {
                            title: "Flesch-Kincaid Grade Level",
                            value: metrics.fleschKincaidGrade,
                            description: getMetricDescription("fleschKincaidGrade", metrics.fleschKincaidGrade),
                        },
                        {
                            title: "Gunning Fog Index",
                            value: metrics.gunningFog,
                            description: getMetricDescription("gunningFog", metrics.gunningFog),
                        },
                        {
                            title: "SMOG Index",
                        ...
                        },
                        {
                            ...
                            description: getMetricDescription("automatedReadabilityIndex", metrics.automatedReadabilityIndex),
                        },
                        {
                            title: "Coleman–Liau Index",
                            value: metrics.colemanLiauIndex,
                            description: getMetricDescription("colemanLiauIndex", metrics.colemanLiauIndex),
                        },
                        {
                            title: "Linsear Write Formula",
                            value: metrics.linsearWriteFormula,
                            description: getMetricDescription("linsearWriteFormula", metrics.linsearWriteFormula),
                        },
                        {
                            title: "Dale–Chall Readability Score",
                            value: metrics.daleChallReadabilityScore,
                            description: getMetricDescription("daleChallReadabilityScore", metrics.daleChallReadabilityScore),
                        },
                    ]
                }
